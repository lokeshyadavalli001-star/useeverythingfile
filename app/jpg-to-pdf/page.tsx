...
import { FileText, Loader2, ArrowUp, ArrowDown, Trash2, CheckCircle2 } from "lucide-react";

export default function JpgToPdfPage() {
  const tool = TOOL_MAP.get("jpg-to-pdf")!;
    ...
    <ToolLayout tool={tool}>
      {downloadUrl ? (
        <ResultCard
          ...
          subtitle={`Combined ${files.length} JPG image${files.length > 1 ? "s" : ""} into a clean document.`}
        />
      ) : (
        <div className="w-full max-w-2xl mx-auto space-y-6">
          <FileDropzone
            ...
            subtitle="Select one or multiple photos to convert into PDF"
          />
